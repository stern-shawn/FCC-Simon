$(document).ready(function() {
  // Try to preload audio to improve performance on mobile...
  ...
  function playBeep(selectedBtn) {
    ...
    // Modification to make this work with preloaded audio instead of instantiating a new audio
    // object for each click (okay for desktops but way too slow on mobile)
    switch (selectedBtn) {
      case 0:
        greenAudio.play();
        break;
